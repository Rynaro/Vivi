...
Load the full methodology: `agents/skills/vivi-methodology.md`
...
| **Standard** | 1-3 files, known patterns, clear scope | Full Vivi, 3 strategies minimum |
| **Complex** | 4+ files, cross-domain, architectural decisions | Full Vivi + test anchoring + architect/editor split |
...
| Planning or scoring strategies | `agents/skills/vivi-methodology.md` |
